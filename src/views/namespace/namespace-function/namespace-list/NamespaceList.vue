<template>
  <div class="namespace_list_container secondary_page_animate">
    <div class="left_container radius">
      <Spin
        v-if="namespaceLoading" size="large" fix
        class="absolute"
      />
      <div class="top_text">
        <p class="head_title">
      ...
      <div class="namespace_list_table">
        ...
        <div class="table_body ">
          <div
            v-for="(n, index) in paginatedNamespaceList" :key="`ns${index}`"
            class=" radius"
          >
            <div v-if="n" class="table_body_item">
              ...
              <span class="more overflow_ellipsis">
                <Poptip
                  v-if="!displayDuration(n).expired || n.levels === 1"
                  class="poptip_container" placement="top-end"
                >
                  <i class="moreFn" />
                  <div slot="content" max-width="150" class="refresh_sub_container">
                    <span v-if="n.levels === 1" class="fnItem pointer" @click.stop="showEditDialog(n)">
      ...
      <div class="page_list_container">
        <Page
          class="page_list" :total="namespaceList.length" :page-size="pageSize"
    ...
    <NamespaceRegistration
      ...
      :show-namespace-edit-dialog="showNamespaceEditDialog"
