    ...
    <div ref="monitorPanelLeftContainer" class="monitor_panel_left_container">
      <div class="top_wallet_address radius">
        <div class="wallet_address">
          ...
          <img
            class="pointer" src="@/common/img/monitor/monitorCopyAddress.png"
            alt="" @click="copyAddress"
          >
        </div>
      ...
      <div class="top_network_info radius">
        <div class="top_wallet_info">
          <div class="netWork radius">
            ...
            <span class="txt_info"><numberGrow :value="chainStatus.nodeNumber" /></span>
          </div>
          ...
          <div class="amount radius">
            ...
            <span class="txt_info">
              <numberGrow :value="chainStatus.numTransactions" />
            </span>
          </div>
          <div class="block_time radius">
            <div class="title">
              <span class="title_txt">
                {{ $t('time') }}
                <span class="title_txt">
                  {{ chainStatus.getTimeFromBlockNumber(chainStatus.currentHeight) }}
                </span>
              </span>
            </div>
            <img src="@/common/img/monitor/amount.png">
            <span class="txt_info">
              <numberGrow :value="chainStatus.targetBlockTime" />
            </span>
          </div>
        </div>
      </div>
