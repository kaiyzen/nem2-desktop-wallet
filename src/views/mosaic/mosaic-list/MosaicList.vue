<template>
  <div class="mosaicList secondary_page_animate">
    <div class="left_container radius">
      <div>
        ...
        <p class="mosaic_head_title_info">
          {{ $t('NEM_Mosaic_is_a_smart_asset_with_rich_attributes_and') }}
        </p>
      </div>
    ...
    <MosaicSupplyChange
      ...
      :show-mosaic-edit-dialog="showMosaicEditDialog"
      :item-mosaic="selectedMosaic"
