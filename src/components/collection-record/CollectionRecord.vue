<template>
  <div class="right_record radius">
    ...
    <div class="top_title">
      ...
      <div v-show="!isShowSearchDetail" class="right">
        ...
        <div class="flex_content">
          <div class="left left_components">
            <div class="top overflow_ellipsis">
              {{ renderMosaicNames(c.rawTx.mosaics, $store) }}
            </div>
            <div class="bottom overflow_ellipsis">
              {{ c.txHeader.time.slice(0, c.txHeader.time.length - 3) }}
            </div>
          </div>
          <div class="right">
            <div class="top overflow_ellipsis">
              {{ renderMosaicAmount(c.rawTx.mosaics, mosaicList, $store) }}
            </div>
            <div class="bottom overflow_ellipsis">
